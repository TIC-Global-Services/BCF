...
const Appointment = () => {
  ...
  return (
    <div className='relative max-w-7xl mx-auto md:mb-0 xl:px-0 lg:px-5 md:px-5 ' ref={ref}> {/* Added mb-10 for mobile */}
      ...
      >
        ...
        <motion.button 
           className="bg-[#F1EFEC] md:text-[18px] text-[12px] text-[#123458] font-medium py-3 px-6 rounded-full 
             transition-all duration-300 ease-in-out cursor-pointer 
             hover:bg-[#e8e5e2] hover:shadow-md"

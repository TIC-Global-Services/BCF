        ...
        <div className="relative">
          ...
          >
            <div className="xl:max-w-5xl lg:max-w-4xl md:max-w-2xl text-center mx-auto max-w-[calc(100%-40px)] text-white px-5">
              ...
              >
                At Bhuma Cast Factory, innovation isn't just about adopting new
                tools — it's about delivering faster, smarter, and more reliable
                solutions to our clients. Our integrated technologies help
                reduce production delays, lower costs, and ensure consistent
                product performance in real-world applications.
              </motion.p>
            </div>
          </motion.div>
        </div>

...
const TeamCarousel = () => {
    ...
    // Properly typed refs for HTML div elements
    ...
    const handlePrevious = () => {
        ...
        if (isMobile) {
            ...
            // Desktop logic - Fixed: Use proper bounds checking
    ...
    const handleNext = () => {
        ...
        if (isMobile) {
            ...
            // Desktop logic - Fixed: Use proper bounds for infinite scroll
            const totalCards = teamMembers.length * 2;
            let newIndex = currentIndex + 1;

            // Reset to beginning of first set when we reach the end
            if (newIndex >= totalCards) {
                newIndex = 0;
            }
            // When we're in the second set, create seamless loop
            else if (newIndex >= teamMembers.length && currentIndex < teamMembers.length) {

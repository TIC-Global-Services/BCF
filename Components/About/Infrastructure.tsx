...
const Infrastructure = () => {
  return (
    <Container>
      <div className="flex md:flex-row flex-col max-w-6xl mx-auto md:h-[736px] md:gap-30 gap-10 md:py-0 py-10 items-center justify-center ">
        <div className="flex flex-col items-start md:space-y-5 space-y-4  ">
          ...
          <div>
            <p className="md:text-[16px] text-[12px] md:leading-[29px] leading-[18px] text-[#3F4348]  ">
              This company was started for Rapid-prototyping not as a small scale
              industry.
            </p>
          </div>
